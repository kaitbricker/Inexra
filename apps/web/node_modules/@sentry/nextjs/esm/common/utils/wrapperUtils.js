...
import { runWithAsyncContext, getCurrentScope, startTransaction, getActiveTransaction, captureException } from '@sentry/core';
  ...
  return async function ( ...args) {
    return runWithAsyncContext(async () => {
      ...
      try {
        ...
        _optionalChain([previousSpan, 'optionalAccess', _3 => _3.setStatus, 'call', _4 => _4('internal_error')]);
        throw e;
      } finally {
        dataFetcherSpan.end();
