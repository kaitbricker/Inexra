...
import { addTracingExtensions, runWithAsyncContext, getCurrentScope, trace, captureException, getClient } from '@sentry/core';
      ...
      res = await trace(
        ...
        async span => {
          ...
          if (options.recordResponse !== undefined ? options.recordResponse : sendDefaultPii) {
            _optionalChain([span, 'optionalAccess', _14 => _14.setData, 'call', _15 => _15('server_action_result', result)]);
          }
          ...
          if (options.formData) {
            ...
            _optionalChain([span, 'optionalAccess', _16 => _16.setData, 'call', _17 => _17('server_action_form_data', formDataObject)]);
          }
