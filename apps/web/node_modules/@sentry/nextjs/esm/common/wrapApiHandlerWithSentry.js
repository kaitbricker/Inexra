...
import { addTracingExtensions, runWithAsyncContext, getCurrentScope, startTransaction, captureException, getClient } from '@sentry/core';
import { logger, isString, tracingContextFromHeaders, stripUrlQueryAndFragment, consoleSandbox, objectify } from '@sentry/utils';
      ...
      const boundHandler = runWithAsyncContext(
        ...
        async () => {
          ...
          if (_optionalChain([options, 'optionalAccess', _4 => _4.instrumenter]) === 'sentry') {
            ...
            const baggage = _optionalChain([req, 'access', _5 => _5.headers, 'optionalAccess', _6 => _6.baggage]);
