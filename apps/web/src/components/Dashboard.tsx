    ...
    <div className="space-y-6">
      {conversations.length === 0 ? (
        <div className="text-center py-12">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">No conversations yet</h2>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Start a conversation to see it here.</p>
        </div>
      ) : (
        <>
